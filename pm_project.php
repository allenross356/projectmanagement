...
4) Rules -
	...
	The employer can send msgs to manager and marketer of the project. The manager can send msgs to employer, marketer, and coder of the project. The coder can send msgs to manager as well as employer, however, if he sends msg to employer, the msg is invigilated by the manager. The marketer can send msgs to employer and manager.
	
	The employer can make project's payment directly through the system, or can make the payment to the marketer.
	
	The employer can request for remote viewing in order to help him set up, run or debug the project. The remote viewing must be facilitated with a manager or marketer of this project (preferrably) or by another manager or marketer or coder. This is to make sure that the coder of this project and the employer don't get involved in exchanging the contact information or talk about the price of the project. The employer can provide time schedules when he is available. The coder can provide his time schedule when he is available. A common time is agreed, and the manager is requested to make himself available at that time, and in return is offer some additional part of profits. If he is not available at that time, any online marketer or manager or coder is requested to invigilate the process for little extra income. Once the meeting is over, the invigilator submits a report about the coder and employer. If no invigilator is available, then the employer and client are allowed to communicate on the app for a while in order to be able to coordinate with each other abt the remote viewing.
	
	After the employer can mark the project complete, or cancel the project. The manager can mark the project Impossible. The marketer can mark the project abandoned by employer, or unfinished by the manager. Once the entire project amount is released, the project is automatically marked complete.
