...
Description: Logged in coder puts an interest in the project. The coder can put interest only if he is currently available and not assigned any projects. If the project is assigned but employer takes too long to respond, the coder will be allowed to put interest on small projects to take them up. But he can be assigned more than x number of projects at any given time. If a project is paused by the employer, the coder will be allowed to take up projects based on the estimated length of time the employer has paused it. If the project is paused more than one time consecutively, the more times its paused, the less reliable his estimated length will be and the more the coder will be free in taking up small or big projects.
...
employerPausesProject($projectId,$estimatedLength)
Permission: Employer
Description: Employer can pause the project (only) for more than a threshold period of time. However, once paused, the project can only be resumed once the coder is available again. During the time when the project is paused, the coder will be freed by the system to take on other projects. Based on the estimated length of the pause, the coder will be allowed to take up small or large projects appropriately. If the employer pauses the project consecutively, then the more he pauses, the less relevant and dependable his estimated time will become, and so the more free the coder will be to take up other projects.
*/
